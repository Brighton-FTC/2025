...
// Third spike
        ...
        Actions.runBlocking(new SequentialAction(startToSub, new InstantAction(grabber::toggleClaw), cycle1, new InstantAction(grabber::toggleClaw), specCycle1, new InstantAction(grabber::toggleClaw), startToPark));
